...
class PickedFileInfo {
  ...
  static PickedFileInfo decode(Object result) {
  ...
  bool operator ==(Object other) {
    if (other is! PickedFileInfo || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
    }
    return _deepEquals(path, other.path) && _deepEquals(name, other.name) && _deepEquals(sizeBytes, other.sizeBytes) && _deepEquals(mimeType, other.mimeType);
  }
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    }    else if (value is PickedFileInfo) {
      buffer.putUint8(129);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 129:
        return PickedFileInfo.decode(readValue(buffer)!);
      default:
...
class FileHostApi {
  /// Constructor for [FileHostApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  FileHostApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<List<PickedFileInfo>> pickFiles() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.neoshare.FileHostApi.pickFiles$pigeonVar_messageChannelSuffix';
  ...
  Future<String> saveToDownloads(String tempPath, String mimeType, String fileName) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[tempPath, mimeType, fileName]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
  ...
  Future<int> getFreeSpace() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.neoshare.FileHostApi.getFreeSpace$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
